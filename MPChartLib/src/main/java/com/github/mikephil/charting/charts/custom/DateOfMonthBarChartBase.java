...
public abstract class DateOfMonthBarChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected DateOfMonthXAxisRender mXAxisRenderer;

    // /** the approximator object used for data filtering */
    // private Approximator mApproximator;

    public DateOfMonthBarChartBase(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public DateOfMonthBarChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DateOfMonthBarChartBase(Context context) {
        super(context);
    }
    ...
    protected void init() {
        ...
        mXAxisRenderer = new DateOfMonthXAxisRender(mViewPortHandler, mXAxis, mLeftAxisTransformer);
...
//        mRenderer.drawExtras(canvas);
    ...
    public DateOfMonthXAxisRender getRendererDateOfMonthXAxis() {
     ...
     * @param xAxisRenderer
     */
    public void setDateOfMonthXAxisRenderer(DateOfMonthXAxisRender xAxisRenderer) {
