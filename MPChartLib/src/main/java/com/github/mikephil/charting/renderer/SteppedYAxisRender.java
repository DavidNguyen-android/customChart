...
public class SteppedYAxisRender extends AxisRenderer {

    protected YAxis mYAxis;

    protected Paint mZeroLinePaint;

    public SteppedYAxisRender(ViewPortHandler viewPortHandler, YAxis yAxis, Transformer trans) {
    ...
    protected void computeAxisValues(float min, float max) {
        mAxis.mEntries = new  float [] {0f,1f,2f,3f};
