 ...
 */
public class DateOfMonthBarChart extends DateOfMonthBarChartBase<BarData> implements BarDataProvider {
    ...
    public DateOfMonthBarChart(Context context) {
        super(context);
    }

    public DateOfMonthBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DateOfMonthBarChart(Context context, AttributeSet attrs, int defStyle) {
