 ...
 */
public class DateOfWeekBarChart extends DateOfWeekBarChartBase<BarData> implements BarDataProvider {
    ...
    public DateOfWeekBarChart(Context context) {
        super(context);
    }

    public DateOfWeekBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DateOfWeekBarChart(Context context, AttributeSet attrs, int defStyle) {
